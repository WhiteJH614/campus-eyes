...
<section class="space-y-8">
        ...
        <div class="relative px-6 py-10 sm:px-10 sm:py-12 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div class="max-w-2xl space-y-4">
                ...
                <p class="text-base" style="color:rgba(255,255,255,0.85);">
                    A friendly, consistent workflow for reporters, technicians, and admins to keep campus spaces safe and working.
                </p>

                {{-- 更加显眼的实时时间 --}}
                <div class="mt-2">
                    <div
                        class="inline-flex items-center gap-2 px-4 py-2 rounded-full shadow-sm"
                        style="background:rgba(255,255,255,0.92);color:#1F4E79;"
                    >
                        <span class="text-xs font-semibold uppercase tracking-wide" style="color:#7F8C8D;">
                            Current campus time
                        </span>
                        <span
                            id="campus-current-time"
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="rounded-xl border p-5 shadow-sm hover:shadow-md transition"
            ...
            <a href="/help" class="inline-flex items-center gap-1 text-sm font-medium mt-3"
               style="color:#1ABC9C;">Help center -></a>
        </div>
    </div>
