            ...
            @if(Auth::user()->role === 'Reporter')
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <a href="{{ route('reports.index') }}"
                        class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg p-6 shadow-sm border dark:border-gray-700 transition-colors">
                        <div class="text-3xl mb-2">📋</div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        @if($reports->isEmpty())
                            <p class="text-gray-500 text-center py-8">No reports yet. <a href="{{ route('reports.create') }}"
                                    class="text-indigo-600 hover:underline">Submit your first report</a></p>
                        @else
                            <div class="space-y-3">
                                    ...
                                    <a href="{{ route('reports.show', $report) }}"
                                        ...
                                        <div class="flex justify-between items-start">
                                            <div>
                                                ...
                                                <span
                                                    class="text-gray-600 dark:text-gray-400">{{ Str::limit($report->description, 50) }}</span>
                                            </div>
