                ...
                <table class="min-w-full text-sm rounded-xl overflow-hidden border border-[#D7DDE5]">
                    <thead>
                        <tr class="bg-[#F5F7FA] text-[#2C3E50]">
                            ...
                            <!-- <th class="text-left px-3 py-2">Reporter ID</th> -->
                    ...
                    <tbody class="text-[#2C3E50] divide-y divide-[#D7DDE5]">
                        @forelse ($rows as $row)
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="px-3 py-2 text-[#7F8C8D]">{{ $row['resolution_notes'] }}</td>
                                <td class="px-3 py-2 whitespace-nowrap">{{ $row['report_at'] }}</td>
                                <td class="px-3 py-2 whitespace-nowrap">{{ $row['due_at'] }}</td>
                                <td class="px-3 py-2 whitespace-nowrap">{{ $row['completed_at'] }}</td>
                                <td class="px-3 py-2">{{ $row['duration'] }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="13" class="px-3 py-4 text-center text-[#7F8C8D]">No completed tasks found for the selected filters.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
